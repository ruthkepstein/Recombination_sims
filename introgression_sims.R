...
for(i in 1:100){
  ...
  pop1_sel1_cross <- randCross2(pop1_sel1_2, goodpop[236,], nCrosses = 10, nProgeny = 10, simParam = SP)
  ...
  pop1_sel2_cross <- randCross2(pop1_sel2_2, goodpop[236,], nCrosses = 10, nProgeny = 10, simParam = SP)
  ...
  pop1_sel3_cross <- randCross2(pop1_sel3_2, goodpop[236,], nCrosses = 10, nProgeny = 10, simParam = SP)
  ...
  pop1_sel4_cross <- randCross2(pop1_sel4_2, goodpop[236,], nCrosses = 10, nProgeny = 10, simParam = SP)
  ...
  pop1_sel5_cross <- randCross2(pop1_sel5_2, goodpop[236,], nCrosses = 10, nProgeny = 10, simParam = SP)
...
for(i in 1:100){
  ...
  pop <- randCross2(goodpop[236,], badpop[110,], nCrosses = 200, nProgeny = 1, simParam = SP)
  pop <- setPheno(pop = pop, h2 = 0.8, simParam = SP)
  ddm1var1[i] <- varA(pop)
