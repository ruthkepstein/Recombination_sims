...
#omit empty col
jap_chr1_snp2<-na.omit(jap_chr1_snp2)
jap_chr2_snp2<-na.omit(jap_chr2_snp2)
jap_chr3_snp2<-na.omit(jap_chr3_snp2)
jap_chr4_snp2<-na.omit(jap_chr4_snp2)
jap_chr5_snp2<-na.omit(jap_chr5_snp2)
jap_chr6_snp2<-na.omit(jap_chr6_snp2)
jap_chr7_snp2<-na.omit(jap_chr7_snp2)
jap_chr8_snp2<-na.omit(jap_chr8_snp2)
jap_chr9_snp2<-na.omit(jap_chr9_snp2)
jap_chr10_snp2<-na.omit(jap_chr10_snp2)
jap_chr11_snp2<-na.omit(jap_chr11_snp2)
jap_chr12_snp2<-na.omit(jap_chr12_snp2)

#gen maps
jap_chr1_snp2 <- jap_chr1_snp2[order(jap_chr1_snp2$`SNP Start`),]
jap_chr1_spl <- smooth.spline(jap_chr1_snp2$rate, spar = .7)
...
jap_chr2_spl <- smooth.spline(jap_chr2_snp2$rate, spar = .7)
...
plot(jap_chr2_snp2$`SNP Start`, jap_chr2_finalpos$pos, type = "l", xlab = "Physical Positions (Mb)",
     ylab = "Genetic Position (cM)", main = "Japonica Chromosome 2 Genetic Map")

jap_chr3_spl <- smooth.spline(jap_chr3_snp2$rate, spar = .7)
...
plot(jap_chr3_snp2$`SNP Start`, jap_chr3_finalpos$pos, type = "l", xlab = "Physical Positions (Mb)",
     ylab = "Genetic Position (cM)", main = "Japonica Chromosome 3 Genetic Map")

jap_chr4_spl <- smooth.spline(jap_chr4_snp2$rate, spar = .8)
...
plot(jap_chr4_snp2$`SNP Start`, jap_chr4_finalpos$pos, type = "l", xlab = "Physical Positions (Mb)",
     ylab = "Genetic Position (cM)", main = "Japonica Chromosome 4 Genetic Map")

jap_chr5_spl <- smooth.spline(jap_chr5_snp2$rate, spar =.7)
...
plot(jap_chr5_snp2$`SNP Start`, jap_chr5_finalpos$pos, type = "l", xlab = "Physical Positions (Mb)",
     ylab = "Genetic Position (cM)", main = "Japonica Chromosome 5 Genetic Map")

#slight increasing
jap_chr6_spl <- smooth.spline(jap_chr6_snp2$rate, spar = .7)
...
plot(jap_chr6_snp2$`SNP Start`, jap_chr6_finalpos$pos, type = "l", xlab = "Physical Positions (Mb)",
     ylab = "Genetic Position (cM)", main = "Japonica Chromosome 6 Genetic Map")

#slight increase
jap_chr7_spl <- smooth.spline(jap_chr7_snp2$rate, spar = 0.7)
...
plot(jap_chr7_snp2$`SNP Start`, jap_chr7_finalpos$pos, type = "l", xlab = "Physical Positions (Mb)",
     ylab = "Genetic Position (cM)", main = "Japonica Chromosome 7 Genetic Map")

jap_chr8_spl <- smooth.spline(jap_chr8_snp2$rate, spar = 1)
...
plot(jap_chr8_snp2$`SNP Start`, jap_chr8_finalpos$pos, type = "l", xlab = "Physical Positions (Mb)",
     ylab = "Genetic Position (cM)", main = "Japonica Chromosome 8 Genetic Map")

#slight increase
jap_chr9_spl <- smooth.spline(jap_chr9_snp2$rate, spar = .7)
...
plot(jap_chr9_snp2$`SNP Start`, jap_chr9_finalpos$pos, type = "l", xlab = "Physical Positions (Mb)",
     ylab = "Genetic Position (cM)", main = "Japonica Chromosome 9 Genetic Map")

#slight increase
jap_chr10_spl <- smooth.spline(jap_chr10_snp2$rate, spar =.7)
...
plot(jap_chr10_snp2$`SNP Start`, jap_chr10_finalpos$pos, type = "l", xlab = "Physical Positions (Mb)",
     ylab = "Genetic Position (cM)", main = "Japonica Chromosome 10 Genetic Map")

jap_chr11_spl <- smooth.spline(jap_chr11_snp2$rate, spar = .9)
...
plot(jap_chr11_snp2$`SNP Start`, jap_chr11_finalpos$pos, type = "l", xlab = "Physical Positions (Mb)",
     ylab = "Genetic Position (cM)", main = "Japonica Chromosome 11 Genetic Map")

jap_chr12_spl <- smooth.spline(jap_chr12_snp2$rate, spar = .9)
...
plot(jap_chr12_snp2$`SNP Start`, jap_chr12_finalpos$pos, type = "l", xlab = "Physical Positions (Mb)",
