...
recq4l_chr2_spl <- smooth.spline(recq4l_chr2_snp2$rate, spar = .67)
...
recq4l_chr3_spl <- smooth.spline(recq4l_chr3_snp2$rate, spar = .65)
...
recq4l_chr6_spl <- smooth.spline(recq4l_chr6_snp2$rate, spar = .745)
