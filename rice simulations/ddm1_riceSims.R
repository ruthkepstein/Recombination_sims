...
avg_diff <-1.6 #in telomeres? should I apply this generally or ... specify telomeric regions?
...
ddm1_chr1_CO_2<-new_rates(WTJap_chr1_CO)
ddm1_chr2_CO_2<-new_rates(WTJap_chr2_CO)
ddm1_chr3_CO_2<-new_rates(WTJap_chr3_CO)
ddm1_chr4_CO_2<-new_rates(WTJap_chr4_CO)
ddm1_chr5_CO_2<-new_rates(WTJap_chr5_CO)
ddm1_chr6_CO_2<-new_rates(WTJap_chr6_CO)
ddm1_chr7_CO_2<-new_rates(WTJap_chr7_CO)
ddm1_chr8_CO_2<-new_rates(WTJap_chr8_CO)
ddm1_chr9_CO_2<-new_rates(WTJap_chr9_CO)
ddm1_chr10_CO_2<-new_rates(WTJap_chr10_CO)
ddm1_chr11_CO_2<-new_rates(WTJap_chr11_CO)
ddm1_chr12_CO_2<-new_rates(WTJap_chr12_CO)
...
ddm1_chr1_spl <- smooth.spline(ddm1_chr1_snp2$rate, spar = .7)
...
ddm1_chr2_spl <- smooth.spline(ddm1_chr2_snp2$rate, spar = .67)
...
ddm1_chr3_spl <- smooth.spline(ddm1_chr3_snp2$rate, spar = .65)
...
ddm1_chr4_spl <- smooth.spline(ddm1_chr4_snp2$rate, spar = .75)
...
ddm1_chr6_spl <- smooth.spline(ddm1_chr6_snp2$rate, spar = .745)
