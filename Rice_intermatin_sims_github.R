...
for(i in 1:100){
  ...
  pop_good1 <- self(pop_good_sel0, keepParents=FALSE, nProgeny=20, simParam = SP)
  ...
  pop_good11 <- self(pop_good_sel10, keepParents=FALSE, nProgeny = 20, simParam = SP)
...
for(i in 1:100){
  ...
  pop_good12 <- self(pop_good_sel11, keepParents=FALSE, nProgeny = 20, simParam = SP)
  ...
  pop_good13 <- self(pop_good_sel12, keepParents=FALSE, nProgeny = 20, simParam = SP)
  ...
  pop_good14 <- self(pop_good_sel13, keepParents=FALSE, nProgeny = 20, simParam = SP)
  ...
  pop_good15 <- self(pop_good_sel14, keepParents=FALSE, nProgeny = 20, simParam = SP)
  ...
  pop_good16 <- self(pop_good_sel14, keepParents=FALSE, nProgeny = 20, simParam = SP)
...
for(i in 1:100){
  ...
  pop_good_sel15 <- selectInd(pop_good15, nInd = 5, use = "gv", trait = 1, selectTop = TRUE, returnPop = TRUE, simParam = SP)
  pop_good16 <- self(pop_good_sel15, keepParents=FALSE, nProgeny = 20, simParam = SP)
